...
GOLD = (232, 202, 124)
LIGHT_GOLD = (255, 233, 170)
WHITE = (255, 255, 255)
SOFT_WHITE = (235, 239, 240)
...
def find_font():
    ...
    possible_fonts = [
        os.path.join(FONT_FOLDER, "NotoNaskhArabic-Bold.ttf"),
        os.path.join(FONT_FOLDER, "NotoNaskhArabic-Regular.ttf"),
        os.path.join(FONT_FOLDER, "arabic.ttf"),
...
def cover_image(image, target_width, target_height):
    ...
    new_width = math.ceil(source_width * scale)
